...
export function AppSidebar({ role, userName, userAvatar }) {
    ...
    <Sidebar>
      <SidebarHeader className="p-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-lg font-bold text-foreground">G-LEARNEX</h2>
      ...
      <SidebarFooter className="p-4 space-y-2">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div className="flex items-center gap-3 p-3 rounded-md bg-card border border-card-border cursor-pointer hover:bg-accent/50 transition-colors">
