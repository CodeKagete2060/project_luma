        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 text-center text-white">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Welcome to <span className="text-yellow-300">LUMA</span>
            </h1>
          ...
          >
            ...
            <p className="text-white/90 text-left">
              Project LUMA is committed to ensuring inclusive and equitable quality education and promoting lifelong learning opportunities for all. 
